...
class ArbaEvntRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "evnt"
    name = f"{project_namespace}-{project_base_name}"
    package_type = "library"

    # Optional metadata
    description = "A C++ library providing tools to manage events."
    url = "https://github.com/arapelle/arba-evnt"
    homepage = "https://github.com/arapelle/arba-evnt"
    topics = ("event-manager", "event")
    license = "MIT"
